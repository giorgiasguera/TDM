...
def main():
    ...
    ap = argparse.ArgumentParser("TDM: Text-Driven Diffusion Model for Sign Language Production")

    # Choose between Train and Test
    ap.add_argument("mode", choices=["train", "test"], help="train a model or test")
    # Path to Config
    ap.add_argument("config_path", default="./Configs/TDM.yaml", type=str, help="path to YAML config file")
